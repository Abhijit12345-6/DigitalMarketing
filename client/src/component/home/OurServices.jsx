...
import icon1 from "../../assets/ser01.png";
import icon2 from "../../assets/ser02.png";
import icon3 from "../../assets/ser03.png";
import icon4 from "../../assets/ser04.png";
import icon5 from "../../assets/ser05.png";
import icon6 from "../../assets/ser06.png";
    ...
    <section className="bg-blue-50 md:p-20 p-10 text-center">
      <div className="w-full mx-auto">
        ...
        <p className="text-gray-600 mb-10 w-full text-start text-lg mx-auto">
          ...
          content marketing, our expert team in Bangalore ensures your brand
